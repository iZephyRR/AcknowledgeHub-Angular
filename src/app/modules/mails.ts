...
export class Mail {
    ...
    static firstLogin(address: string, name: string): Email {
        ...
        return {
            ...
            message: 'Dear ' + name + ',<br><br>Welcome to Acknowledge-Hub!<br><br>To complete your account setup, please:<br>Confirm Your Email:<br>Enter the following One-Time Password (OTP):<br><p style="color:gray;">' + Mail.otp + '</p>(Valid for 5 minutes)<br><br>Update Your Password:<br>You’ll be prompted to change your password upon your first login with the default one. This step is mandatory to secure your account.<br>If you need assistance, please contact IT Support.<br><br>Thank you for using Acknowledge-Hub.<br><br>Best regards,<br>The Acknowledge-Hub Team<br>teamechofive@gmail.com'
        };
    }
    ...
    static addedCompany(address:string, name: string, defaultPassword:string):Email{
        ...
        // <br>Website link - 127.0.0.1:4200/
    }
}